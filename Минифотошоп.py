...
filename = input('''Введите название изображения в формате jpg (без его расширения), которое вам нужно обработать.
Если изображение находится не в директории программы, необходимо указать полный путь до него.\n''')
